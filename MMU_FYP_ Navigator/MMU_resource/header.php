...
<body>
    <header>
        <div class="navbar">
            <div class="logo">
                <a href="<?php echo $_SESSION['is_admin'] ? 'adminpanel.php' : 'home.php'; ?>"><img src="design/logo.png" alt="MMU Resources Logo"></a>
            </div>
                ...
                <nav>
                    <ul>
                        ...
                        <?php else: ?>
                            ...
                            <li><a href="manage_feedback.php" class="<?php echo $current_page == 'manage_feedback.php' ? 'active' : ''; ?>">View Feedback</a></li>
                ...
                <?php if(isset($_SESSION['user_id'])): ?>
                    <?php if (!$_SESSION['is_admin']): ?>
                        <div class="cart-container">
                            <a href="cart.php" class="cart-icon <?php echo $current_page == 'cart.php' ? 'active' : ''; ?>">
                                <img src="design/cart.png" alt="Cart Icon" class="cart-icon-image">
                                <?php if ($cart_count > 0): ?>
                    ...
                    <div class="profile">
                        ...
                        <div class="profile-dropdown">
                            <span><?php echo $_SESSION['username']; ?> <img src="design/arrow.png" class="arrow" alt="Arrow Icon"></span>
