...
$default_profile_picture = 'profilePicture/super/default.png';
            ...
            if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] == 0) {
                ...
                if (in_array($imageFileType, $allowed_types)) {
                    if (move_uploaded_file($_FILES["profile_picture"]["tmp_name"], $target_file)) {
                        $profile_picture = htmlspecialchars($target_file);
                    } else {
                ...
                $profile_picture = htmlspecialchars($users['profile_picture']);
            }
    ...
    <div class="profile-container">
        <div class="profile-sidebar">
            <div class="profile-pic-container">
                <!-- Display user's profile picture or a default picture if none is set -->
                ...
                <div class="svg-container">
                    <label for="profile_picture" class="custom-file-upload">
                        <!-- SVG icon for profile picture upload button -->
        ...
        <div class="profile-main">
            <h2>Manage Profile</h2> <!-- Section title -->
