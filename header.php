                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a href="<?php echo $_SESSION['is_admin'] ? 'adminpanel.php' : 'home.php'; ?>" class="nav-link text-primary <?php echo $current_page == ($_SESSION['is_admin'] ? 'adminpanel.php' : 'home.php') ? 'active' : ''; ?>">Home</a>
                            </li>
                            <?php if (!$_SESSION['is_admin']): ?>
                                ...
                                <li class="nav-item">
                                    <a href="upload_resource.php" class="nav-link text-primary <?php echo $current_page == 'upload_resource.php' ? 'active' : ''; ?>">Upload Resource</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="about_us.php" class="nav-link text-primary <?php echo $current_page == 'about_us.php' ? 'active' : ''; ?>">About Us</a>
                                </li>
                            <?php else: ?>
                                <li class="nav-item">
                                    <a href="my_announcements.php" class="nav-link text-primary <?php echo $current_page == 'my_announcements.php' ? 'active' : ''; ?>">My Announcements</a>
                                </li>
                                <li class="nav-item">
