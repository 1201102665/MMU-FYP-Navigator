...
// Retrieve the success message from the session, if any
$success = '';
...
<head>
    ...
    <title>Home - MMU-FYP Navigator</title>
</head>
<body>
    ...
    <div class="main-container">
        ...
        <?php endif; ?>
        <h1>Welcome to MMU-FYP Navigator, <?php echo htmlspecialchars($_SESSION['username']); ?>!</h1>
        <br>
        <br>
